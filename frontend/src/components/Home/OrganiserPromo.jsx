...
const OrganiserPromo = () => {
  ...
  return (
    <section className="py-24 relative z-10 bg-dark-bg overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="relative rounded-2xl glassmorphism border-2 border-white/10 p-2 shadow-2xl rotate-[-2deg] hover:rotate-0 transition-transform duration-500 group">
              ...
              {/* Fake Browser Chrome */}
              <div className="bg-dark-surface rounded-t-xl px-4 py-3 flex items-center gap-2 border-b border-white/5">
                <div className="w-3 h-3 rounded-full bg-red-500" />
                <div className="w-3 h-3 rounded-full bg-yellow-500" />
                <div className="w-3 h-3 rounded-full bg-green-500" />
                <div className="ml-4 px-3 py-1 text-xs text-gray-500 bg-black/30 rounded-md">organiser.stms.com</div>
              </div>
              
              {/* Fake Dashboard Content */}
              <div className="bg-[#0B0F19] rounded-b-xl p-6 h-[400px] flex flex-col gap-4">
                ...
                <div className="flex-grow bg-white/5 rounded-xl border border-white/5 flex p-4 gap-4">
                  <div className="w-2/3 h-full bg-white/5 rounded-lg animate-pulse" />
          ...
          >
            <h2 className="text-3xl md:text-5xl font-heading font-bold text-white mb-6 uppercase tracking-tight">
              Host Like a <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-400">Pro</span>
            </h2>
            ...
            <Link 
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-primary text-white font-bold rounded-xl shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-all hover:-translate-y-1"
            >
              Start Organising
            </Link>
          </motion.div>
